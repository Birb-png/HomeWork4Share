...
public class CSMOVIELAB {
    ...
    private static void q3() {
        ...
        if (maxGrossMovie != null) {
            ...
            System.out.println("Name: " + maxGrossMovie.getTitle() + " - Highest Gross: " + maxGrossMovie.getGross());
    ...
    private static void q6() {
        ...
        if (maxBudgetMovie != null && minBudgetMovie != null) {
            System.out.println("Movie with the highest budget: " + maxBudgetMovie.getTitle() + " - Budget: "
                    + maxBudgetMovie.getBudget());
            System.out.println("Movie with the lowest budget: " + minBudgetMovie.getTitle() + " - Budget: "
                    + minBudgetMovie.getBudget());
        }
    }
        ...
        movies.stream()
                ...
                .collect(Collectors.groupingBy(CSMovie::getGenre,
                        Collectors.collectingAndThen(Collectors.toList(),
                                list -> list.stream().sorted(Comparator.comparing(CSMovie::getScore).reversed())
                                        .limit(3))))
    ...
    private static void q8() {
        ...
        List<CSMovie> top3ActionMovies = movies.stream()
                ...
                .sorted(Comparator.comparing(CSMovie::getScore, Comparator.reverseOrder())
        ...
        // .forEach(movie -> System.out.println(movie.getTitle() + " - Score: " +
        // movie.getScore()));
    ...
    private static void q9() {
        ...
        // revenuePerGenre.forEach((genre, totalRevenue) -> System.out.println(genre +
        // ": " + totalRevenue));
